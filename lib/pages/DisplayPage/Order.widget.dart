...
class _OrderWidgetState extends State<OrderWidget> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              widget.order.createdAt == widget.order.pickUpDate
                  ? Container()
                  : Row(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                                DateFormat('hh:mm')
                                    .format(widget.order.pickUpDate),
                                style:
                                    Theme.of(context).textTheme.displaySmall),
                          ],
                        )
  ...
  Widget _buildSelectedIngredients(OrderItem item) {
    ...
    for (Ingredient ingredient in item.selectedIngredients) {
      if (ingredient.Default && !ingredient.Selected) {
        widgets.add(Text('OHNE ${ingredient.Name}',
            style: Theme.of(context).textTheme.bodyLarge));
      } else if (!ingredient.Default && ingredient.Selected) {
        widgets.add(Text('MIT ${ingredient.Name}',
            style: Theme.of(context).textTheme.bodyLarge));
      }
    }
    return Column(
  ...
  Icon _chooseDeliveryTypeIcon(
      DeliveryType deliveryType, BuildContext context) {
  ...
  _buildExtras(OrderItem item) {
    ...
    for (Extra extra in item.selectedExtras) {
      widgets.add(Text('MIT ${extra.Name}',
          style: Theme.of(context).textTheme.bodyLarge));
    }
    return Column(
      children: widgets,
